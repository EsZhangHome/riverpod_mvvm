...
| `ref.invalidate` | 标记列表、详情或物流状态失效，让下次读取重建 | `OrdersPage`、`OrderFeedNotifier` |
...
| Service `Provider` | 注入网络、App 信息、存储和 API 服务 | `core/providers/services.dart` |
...
1. `lib/core/providers/services.dart`
2. `lib/global/auth_provider.dart`
3. `lib/global/theme_provider.dart`
4. `lib/features/mine/view_model/mine_view_model.dart`
5. `lib/features/mine/view/mine_page.dart`
6. `test/features/mine/global_service_providers_test.dart`
