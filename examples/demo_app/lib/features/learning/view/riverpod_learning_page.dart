...
class RiverpodLearningPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text(DemoStrings.learningCenterTitle)),
      body: ListView(
        ...
        children: [
          SegmentedButton<RiverpodLessonStage>(
            segments: const [
              ButtonSegment(
                ...
                label: Text(DemoStrings.learningBasic),
              ),
              ButtonSegment(
                value: RiverpodLessonStage.async,
                label: Text(DemoStrings.learningAsync),
              ),
              ButtonSegment(
                value: RiverpodLessonStage.global,
                label: Text(DemoStrings.learningGlobal),
              ),
            ],
            selected: {stage},
          ...
          const SizedBox(height: AppSpacing.lg),
          Text(
            DemoStrings.learningCodeExamples,
            ...
            children: [
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  label: const Text(DemoStrings.learningPrevious),
                ),
              ),
              ...
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  label: const Text(DemoStrings.learningNext),
                ),
              ),
            ],
          ),
          ...
          FilledButton.icon(
            ...
            label: const Text(DemoStrings.learningOpenPractice),
          ),
        ],
      ),
    );
  ...
  String _practiceRoute(RiverpodLessonStage stage) => switch (stage) {
    ...
    RiverpodLessonStage.basic => DemoRoutePaths.mainHome,
    RiverpodLessonStage.async => DemoRoutePaths.mainOrders,
    RiverpodLessonStage.global => DemoRoutePaths.mainMine,
  };
}
