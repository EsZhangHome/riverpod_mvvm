...
class _HomePageState extends ConsumerState<HomePage> {
    ...
    ref.listen(cartSummaryProvider.select((value) => value.totalQuantity), (
      ...
      if (previous != null && next > previous) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text(DemoStrings.cartAdded(next))));
      }
    });

    return Scaffold(
      appBar: AppBar(
        title: const Text(DemoStrings.catalogTitle),
        ...
        children: [
          ...
          TextField(
            ...
            decoration: const InputDecoration(
              ...
              labelText: DemoStrings.searchProducts,
          ...
          Wrap(
            ...
            children: [
              ChoiceChip(
                label: const Text(DemoStrings.all),
              ...
              FilterChip(
                label: const Text(DemoStrings.favoritesOnly),
          ...
          if (products.isEmpty)
            const Padding(
              ...
              child: Center(child: Text(DemoStrings.catalogEmpty)),
            )
          else
  ...
  String _categoryLabel(ProductCategory category) => switch (category) {
    ProductCategory.phone => DemoStrings.phoneCategory,
    ProductCategory.computer => DemoStrings.computerCategory,
    ProductCategory.accessory => DemoStrings.accessoryCategory,
  };
}
  ...
  Widget build(BuildContext context) {
    return const Card(
      child: Padding(
        ...
        child: Text(DemoStrings.catalogSceneDescription),
      ),
    );
  }
}
...
class _CartActions extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Row(
      ...
      children: [
        Center(child: Text(DemoStrings.cartItemCount(count))),
        IconButton(
          tooltip: DemoStrings.openCart,
          // push 保留首页路由栈；返回时搜索、收藏和购物车仍是原状态。
          onPressed: () => context.push(DemoRoutePaths.mainCart),
          ...
          children: [
            Row(
              children: [
                ...
                IconButton(
                  tooltip: DemoStrings.toggleFavorite,
