...
import 'package:riverpod_mvvm_demo/features/orders/view_model/order_view_model.dart';
...
void main() {
  test('订单列表在初始加载后可分页，创建时保留已有数据', () async {
    ...
    expect(afterCreate.operationResult?.message, DemoStrings.orderCreated);
  ...
  test('取消订单先乐观更新，请求失败后回滚原状态', () async {
    ...
    expect(
      ...
      DemoStrings.orderCancelRolledBack,
    );
