...
class AppStrings {
  ...
  static const String globalLearningCodeEntry =
      'features/auth/auth.dart + shared/theme/theme_provider.dart → features/mine/view_model → view';
  ...
  /// 请求超时提示
  static const String requestTimeout = NetworkErrorMessages.requestTimeout;

  /// 请求已取消提示
  static const String requestCanceled = NetworkErrorMessages.requestCanceled;

  /// 网络连接异常提示
  static const String networkError = NetworkErrorMessages.networkError;

  /// 证书校验失败提示
  static const String certificateError = NetworkErrorMessages.certificateError;

  /// 未知错误提示
  static const String unknownError = NetworkErrorMessages.unknownError;

  /// 服务器异常提示
  static const String serverError = NetworkErrorMessages.serverError;
